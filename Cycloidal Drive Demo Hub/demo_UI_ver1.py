...
rax = plt.axes([0.025, 0.74, 0.15, 0.14], facecolor=axcolor)
radio = RadioButtons(rax, ('Mode 1', 'Mode 2'), active=0)
rax_1 = plt.axes([0.025, 0.57, 0.15, 0.14], facecolor=axcolor)
radio_1 = RadioButtons(rax_1, ('Pin', 'NonePin'), active=0)
rax_2 = plt.axes([0.025, 0.39, 0.15, 0.15], facecolor=axcolor)
